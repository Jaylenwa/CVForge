...
export const TemplateCNWave: React.FC<{ data: ResumeData; styles: any; disableShadow?: boolean }> = ({ data, styles, disableShadow }) => {
  ...
  return (
    <div className={`w-full bg-white text-slate-800 h-auto ${disableShadow ? 'shadow-none' : 'shadow-lg'} print:shadow-none`} style={{ fontFamily: '"PingFang SC", "Microsoft YaHei", sans-serif' }}>
      {/* 顶部波浪背景 */}
