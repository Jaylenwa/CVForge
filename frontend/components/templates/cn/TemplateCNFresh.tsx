...
export const TemplateCNFresh: React.FC<{ data: ResumeData; styles: any; disableShadow?: boolean }> = ({ data, styles, disableShadow }) => {
  ...
  return (
    <div className={`w-full bg-[#f0f9f4] text-[#2d3748] h-full min-h-[1123px] ${disableShadow ? 'shadow-none' : 'shadow-lg'} print:shadow-none print:min-h-0 print:h-auto overflow-hidden`} style={{ fontFamily: '"Nunito", "Microsoft YaHei", sans-serif' }}>
       {/* 装饰性背景 */}
