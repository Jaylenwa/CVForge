      ...
      <div className="px-10 pt-6 pb-10 space-y-1">
                {sectionsOrdered.map((section, idx) => (
                  (() => {
                    ...
                    <div className="absolute left-[-32px] -translate-x-1/2 -translate-y-1/2 w-8 h-8 rounded-full flex items-center justify-center text-white shadow print:shadow-none z-10" style={{ backgroundColor: color, top: -1 }}>
