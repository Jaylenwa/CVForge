...
export const MOCK_TEMPLATES: Template[] = [
  ...
  { id: 'TemplateBold', name: '创意大胆', tags: ['创意', '营销', '色彩'], usageCount: 0, isPremium: true, category: 'Creative' },
  { id: 'TemplateCNBlue', name: '蓝色简约', tags: ['通用', '中文', 'ATS 友好'], usageCount: 0, isPremium: false, category: 'General' },
  { id: 'TemplateCNModern', name: '现代中文', tags: ['现代', '中文', '清爽'], usageCount: 0, isPremium: false, category: 'General' },
  { id: 'TemplateCNBusiness', name: '商务专业', tags: ['商务', '中文', '专业'], usageCount: 0, isPremium: false, category: 'Finance' },
  { id: 'TemplateCNCreative', name: '中文创意', tags: ['创意', '中文', '设计'], usageCount: 0, isPremium: true, category: 'Creative' },
  { id: 'TemplateCNFresh', name: '清新绿色', tags: ['清新', '中文', '绿色'], usageCount: 0, isPremium: false, category: 'General' },
  { id: 'TemplateCNTimeline', name: '时间轴信息图', tags: ['时间轴', '中文', '信息图'], usageCount: 0, isPremium: false, category: 'General' },
