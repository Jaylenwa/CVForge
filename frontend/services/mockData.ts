...
export const MOCK_TEMPLATES: Template[] = [
  ...
  { id: 't2', name: '创意大胆', tags: ['创意', '营销', '色彩'], popularity: 65, isPremium: true, category: 'Creative' },
  { id: 't3', name: '蓝色简约', tags: ['通用', '中文', 'ATS 友好'], popularity: 75, isPremium: false, category: 'General' },
  { id: 't4', name: '现代中文', tags: ['现代', '中文', '清爽'], popularity: 82, isPremium: false, category: 'General' },
  { id: 't5', name: '商务专业', tags: ['商务', '中文', '专业'], popularity: 85, isPremium: false, category: 'Finance' },
  { id: 't6', name: '中文创意', tags: ['创意', '中文', '设计'], popularity: 78, isPremium: true, category: 'Creative' },
  { id: 't7', name: '清新绿色', tags: ['清新', '中文', '绿色'], popularity: 76, isPremium: false, category: 'General' },
  { id: 't8', name: '时间轴信息图', tags: ['时间轴', '中文', '信息图'], popularity: 70, isPremium: false, category: 'General' },
  { id: 't9', name: '毛笔艺术', tags: ['毛笔', '中文', '艺术'], popularity: 58, isPremium: true, category: 'Creative' },
  { id: 't10', name: '云朵柔和', tags: ['云端', '中文', '柔和'], popularity: 66, isPremium: false, category: 'IT' },
  { id: 't11', name: '金融数据', tags: ['金融', '中文', '数据'], popularity: 82, isPremium: false, category: 'Finance' },
  { id: 't12', name: '游戏趣味', tags: ['游戏', '中文', '趣味'], popularity: 64, isPremium: false, category: 'IT' },
  { id: 't13', name: '几何图形', tags: ['几何', '中文', '造型'], popularity: 72, isPremium: false, category: 'General' },
  { id: 't14', name: '医疗洁净', tags: ['医疗', '中文', '洁净'], popularity: 74, isPremium: false, category: 'General' },
  { id: 't15', name: '折纸艺术', tags: ['折纸', '中文', '纸感'], popularity: 60, isPremium: true, category: 'Creative' },
  { id: 't16', name: '像素复古', tags: ['像素', '中文', '复古'], popularity: 55, isPremium: true, category: 'IT' },
  { id: 't17', name: '流线波纹', tags: ['波纹', '中文', '流线'], popularity: 70, isPremium: false, category: 'Creative' },
  { id: 't18', name: '米色宣纸', tags: ['中国风', '单列', '温润'], popularity: 80, isPremium: false, category: 'General' },
  { id: 't19', name: '竹韵清雅', tags: ['中国风', '单列', '清雅'], popularity: 76, isPremium: false, category: 'General' },
  { id: 't20', name: '梅韵简雅', tags: ['中国风', '单列', '简雅'], popularity: 72, isPremium: false, category: 'General' },
];
