...
func DefaultSeed() (SeedData, error) {
	return SeedData{
		...
		Presets: []SeedContentPreset{
			{ExternalID: "it_backend_java_zh", Name: "Java 开发（中文示例）", Language: "zh", RoleExternalID: "Java", Tags: "Java,后端,中文", DataJSON: string(presets.GenerateJavaPreset()), IsActive: true},
			{ExternalID: "it_backend_python_zh", Name: "Python 开发（中文示例）", Language: "zh", RoleExternalID: "Python", Tags: "Python,后端,中文", DataJSON: string(presets.GeneratePythonPreset()), IsActive: true},
			{ExternalID: "it_backend_golang_zh", Name: "Go 开发（中文示例）", Language: "zh", RoleExternalID: "golang", Tags: "Go,后端,中文", DataJSON: string(presets.GenerateGolangPreset()), IsActive: true},
		},
	}, nil
}
