...
var seedPresets = []SeedContentPreset{
	...
	{Name: "Web 前端开发", Language: "zh", RoleCode: "web_frontend", DataJSON: string(presets.GenerateWebFrontendPreset()), IsActive: true},
	{Name: "Web Frontend Developer", Language: "en", RoleCode: "web_frontend", DataJSON: string(presets.GenerateWebFrontendPresetEn()), IsActive: true},
	{Name: "HTML5 前端开发", Language: "zh", RoleCode: "html5", DataJSON: string(presets.GenerateHTML5Preset()), IsActive: true},
	{Name: "HTML5 Developer", Language: "en", RoleCode: "html5", DataJSON: string(presets.GenerateHTML5PresetEn()), IsActive: true},
	{Name: "小程序开发", Language: "zh", RoleCode: "miniapp", DataJSON: string(presets.GenerateMiniappPreset()), IsActive: true},
	{Name: "Mini App Developer", Language: "en", RoleCode: "miniapp", DataJSON: string(presets.GenerateMiniappPresetEn()), IsActive: true},
	{Name: "Android 开发", Language: "zh", RoleCode: "android", DataJSON: string(presets.GenerateAndroidPreset()), IsActive: true},
	{Name: "Android Developer", Language: "en", RoleCode: "android", DataJSON: string(presets.GenerateAndroidPresetEn()), IsActive: true},
	{Name: "iOS 开发", Language: "zh", RoleCode: "ios", DataJSON: string(presets.GenerateIOSPreset()), IsActive: true},
	{Name: "iOS Developer", Language: "en", RoleCode: "ios", DataJSON: string(presets.GenerateIOSPresetEn()), IsActive: true},
	{Name: "鸿蒙开发工程师", Language: "zh", RoleCode: "harmony", DataJSON: string(presets.GenerateHarmonyPreset()), IsActive: true},
	{Name: "HarmonyOS Developer", Language: "en", RoleCode: "harmony", DataJSON: string(presets.GenerateHarmonyPresetEn()), IsActive: true},
	{Name: "测试工程师", Language: "zh", RoleCode: "test_engineer", DataJSON: string(presets.GenerateTestEngineerPreset()), IsActive: true},
	{Name: "Testing Engineer", Language: "en", RoleCode: "test_engineer", DataJSON: string(presets.GenerateTestEngineerPresetEn()), IsActive: true},
	{Name: "自动化测试", Language: "zh", RoleCode: "automation_test", DataJSON: string(presets.GenerateAutomationTestPreset()), IsActive: true},
	{Name: "Automation Testing", Language: "en", RoleCode: "automation_test", DataJSON: string(presets.GenerateAutomationTestPresetEn()), IsActive: true},
	{Name: "测试开发", Language: "zh", RoleCode: "test_dev", DataJSON: string(presets.GenerateTestDevPreset()), IsActive: true},
	{Name: "Testing Development", Language: "en", RoleCode: "test_dev", DataJSON: string(presets.GenerateTestDevPresetEn()), IsActive: true},
	{Name: "性能测试", Language: "zh", RoleCode: "performance_test", DataJSON: string(presets.GeneratePerformanceTestPreset()), IsActive: true},
	{Name: "Performance Testing", Language: "en", RoleCode: "performance_test", DataJSON: string(presets.GeneratePerformanceTestPresetEn()), IsActive: true},
	{Name: "硬件测试工程师", Language: "zh", RoleCode: "hardware_test", DataJSON: string(presets.GenerateHardwareTestPreset()), IsActive: true},
	{Name: "Hardware Testing Engineer", Language: "en", RoleCode: "hardware_test", DataJSON: string(presets.GenerateHardwareTestPresetEn()), IsActive: true},
	{Name: "运维工程师", Language: "zh", RoleCode: "ops_engineer", DataJSON: string(presets.GenerateOpsEngineerPreset()), IsActive: true},
	{Name: "Operations Engineer", Language: "en", RoleCode: "ops_engineer", DataJSON: string(presets.GenerateOpsEngineerPresetEn()), IsActive: true},
	{Name: "DevOps工程师", Language: "zh", RoleCode: "devops", DataJSON: string(presets.GenerateDevopsPreset()), IsActive: true},
	{Name: "DevOps Engineer", Language: "en", RoleCode: "devops", DataJSON: string(presets.GenerateDevopsPresetEn()), IsActive: true},
	{Name: "系统/网络管理员", Language: "zh", RoleCode: "sys_admin", DataJSON: string(presets.GenerateSysAdminPreset()), IsActive: true},
	{Name: "System/Network Administrator", Language: "en", RoleCode: "sys_admin", DataJSON: string(presets.GenerateSysAdminPresetEn()), IsActive: true},
	{Name: "数据库管理员（DBA）", Language: "zh", RoleCode: "dba", DataJSON: string(presets.GenerateDbaPreset()), IsActive: true},
	{Name: "Database Administrator (DBA)", Language: "en", RoleCode: "dba", DataJSON: string(presets.GenerateDbaPresetEn()), IsActive: true},
	{Name: "安全工程师", Language: "zh", RoleCode: "security_engineer", DataJSON: string(presets.GenerateSecurityEngineerPreset()), IsActive: true},
	{Name: "Security Engineer", Language: "en", RoleCode: "security_engineer", DataJSON: string(presets.GenerateSecurityEngineerPresetEn()), IsActive: true},
	{Name: "云计算工程师", Language: "zh", RoleCode: "cloud_engineer", DataJSON: string(presets.GenerateCloudEngineerPreset()), IsActive: true},
	{Name: "Cloud Engineer", Language: "en", RoleCode: "cloud_engineer", DataJSON: string(presets.GenerateCloudEngineerPresetEn()), IsActive: true},
	{Name: "运维经理/主管", Language: "zh", RoleCode: "ops_manager", DataJSON: string(presets.GenerateOpsManagerPreset()), IsActive: true},
	{Name: "Operations Manager/Supervisor", Language: "en", RoleCode: "ops_manager", DataJSON: string(presets.GenerateOpsManagerPresetEn()), IsActive: true},
	{Name: "数据挖掘", Language: "zh", RoleCode: "data_mining", DataJSON: string(presets.GenerateDataMiningPreset()), IsActive: true},
	{Name: "Data Mining", Language: "en", RoleCode: "data_mining", DataJSON: string(presets.GenerateDataMiningPresetEn()), IsActive: true},
	{Name: "自然语言处理", Language: "zh", RoleCode: "nlp", DataJSON: string(presets.GenerateNlpPreset()), IsActive: true},
	{Name: "Natural Language Processing", Language: "en", RoleCode: "nlp", DataJSON: string(presets.GenerateNlpPresetEn()), IsActive: true},
	{Name: "机器学习/AI工程师", Language: "zh", RoleCode: "ml_ai", DataJSON: string(presets.GenerateMlAiPreset()), IsActive: true},
	{Name: "Machine Learning/AI Engineer", Language: "en", RoleCode: "ml_ai", DataJSON: string(presets.GenerateMlAiPresetEn()), IsActive: true},
	{Name: "大数据工程师", Language: "zh", RoleCode: "bigdata", DataJSON: string(presets.GenerateBigdataPreset()), IsActive: true},
	{Name: "Big Data Engineer", Language: "en", RoleCode: "bigdata", DataJSON: string(presets.GenerateBigdataPresetEn()), IsActive: true},
	{Name: "区块链开发工程师", Language: "zh", RoleCode: "blockchain", DataJSON: string(presets.GenerateBlockchainPreset()), IsActive: true},
	{Name: "Blockchain Developer", Language: "en", RoleCode: "blockchain", DataJSON: string(presets.GenerateBlockchainPresetEn()), IsActive: true},
	{Name: "算法工程师", Language: "zh", RoleCode: "algo_engineer", DataJSON: string(presets.GenerateAlgoEngineerPreset()), IsActive: true},
	{Name: "Algorithm Engineer", Language: "en", RoleCode: "algo_engineer", DataJSON: string(presets.GenerateAlgoEngineerPresetEn()), IsActive: true},
}
